...
<head>
    ...
    <title>Kuis Praktikum Pemrograman Web</title>
    <!-- BOOTSTRAP STYLES-->
...
float: right;
font-size: 16px;"> Last Access : <?php date_default_timezone_set('Asia/Jakarta');
                                    echo date("d M Y, H:i:s") ?> &nbsp; <a href="index.php?halaman=logout" class="btn btn-danger square-btn-adjust">Logout</a> </div>
        </nav>
        <!-- /. NAV TOP  -->
